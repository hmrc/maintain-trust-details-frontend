    ...
    "successfully map data" when {
        ...
        "TrustOwnUKLandOrPropertyPage and TrustEEAYesNoPage populated" when {
          ...
          "BusinessRelationshipYesNoPage populated" in {
            ...
            val userAnswers = baseAnswers
              ...
              .success
              .value
              .set(TrustResidentInUkPage, false)
              .success
              .value
          ...
          "BusinessRelationshipYesNoPage not populated" in {
            ...
            val userAnswers = baseAnswers
              ...
              .success
              .value
              .set(TrustResidentInUkPage, true)
              .success
              .value
      ...
      "migrating" when {
        ...
        "governed and administered in UK; set up after settlor died; trustees UK based; never resident offshore; Schedule 3a Exempt" in {
          ...
          val userAnswers = baseAnswers
            .copy(registeredWithDeceasedSettlor = true)
            .set(GovernedByUkLawPage, true)
            .success
            .value
            .set(AdministeredInUkPage, true)
            .success
            .value
            ...
            .success
            .value
            .set(PreviouslyResidentOffshorePage, false)
            .success
            .value
            .set(Schedule3aExemptYesNoPage, true)
            .success
        ...
        "governed and administered in UK; not set up after settlor died;" +
          "deed of variation set up in addition to will trust; trustees UK based; resident offshore; not Schedule 3a Exempt" in {
            ...
            val userAnswers = baseAnswers
              ...
              .success
              .value
              .set(CreatedUnderScotsLawPage, false)
              .success
              .value
              .set(PreviouslyResidentOffshorePage, true)
              .success
              .value
              .set(PreviouslyResidentOffshoreCountryPage, country)
              .success
              .value
            ...
            result mustBe JsSuccess(
              MigratingTrustDetails(
                ...
                administrationCountry = GB,
                residentialStatus =
                  ResidentialStatusType(uk = Some(UkType(scottishLaw = false, preOffShore = Some(country)))),
                trustUKProperty = true,
                trustRecorded = true,
                trustUKRelation = None,
                trustUKResident = true,
        ...
        "governed and administered in UK; not set up after settlor died;" +
          "deed of variation not set up in addition to will trust; trustees UK based; resident offshore; Schedule 3a Exempt" in {
            ...
            val userAnswers = baseAnswers
              .copy(registeredWithDeceasedSettlor = false)
              .set(GovernedByUkLawPage, true)
              .success
              .value
              .set(AdministeredInUkPage, true)
        ...
        "governed and administered in UK; not set up after settlor died; inter-vivos with holdover relief;" +
          "some trustees UK based; settlors UK based; resident offshore; not Schedule 3a Exempt" in {
            ...
            val userAnswers = baseAnswers
              ...
              .success
              .value
              .set(TypeOfTrustPage, InterVivosSettlement)
              .success
              .value
        ...
        "governed and administered outside UK; not set up after settlor died; employee-related with EFRBS;" +
          "some trustees UK based; settlors non-UK based; settlor benefits from assets; Schedule 3a Exempt" in {
            ...
            val userAnswers = baseAnswers
              ...
              .success
              .value
              .set(GoverningCountryPage, country)
              .success
              .value
              .set(AdministeredInUkPage, false)
              .success
              .value
              .set(AdministrationCountryPage, country)
              .success
              .value
              .set(TypeOfTrustPage, EmploymentRelated)
              .success
              .value
              ...
              .success
              .value
              .set(BusinessRelationshipInUkPage, false)
              .success
              .value
              .set(SettlorBenefitsFromAssetsPage, true)
              .success
              .value
              .set(Schedule3aExemptYesNoPage, true)
              .success
            ...
            result mustBe JsSuccess(
              MigratingTrustDetails(
                ...
                residentialStatus = ResidentialStatusType(nonUK =
                  Some(NonUKType(sch5atcgga92 = true, s218ihta84 = None, agentS218IHTA84 = None))
                ),
                trustUKProperty = true,
                trustRecorded = true,
        ...
        "governed and administered outside UK; not set up after settlor died; flat management; no trustees UK based;" +
          "not for purpose of section 218; Schedule 3a Exempt" in {
            ...
            val userAnswers = baseAnswers
              ...
              .success
              .value
              .set(TypeOfTrustPage, FlatManagementCompanyOrSinkingFund)
              .success
              .value
              .set(OwnsUkLandOrPropertyPage, true)
              .success
              ...
              .success
              .value
              .set(ForPurposeOfSection218Page, false)
              .success
              .value
              .set(Schedule3aExemptYesNoPage, true)
              .success
            ...
            result mustBe JsSuccess(
              MigratingTrustDetails(
                ...
                administrationCountry = country,
                residentialStatus = ResidentialStatusType(nonUK =
                  Some(NonUKType(sch5atcgga92 = false, s218ihta84 = Some(false), agentS218IHTA84 = None))
                ),
                trustUKProperty = true,
                trustRecorded = true,
                trustUKRelation = Some(true),
        ...
        "governed and administered outside UK; not set up after settlor died; historic buildings;" +
          "no trustees UK based; for purpose of section 218; not Schedule 3a Exempt" in {
            ...
            val userAnswers = baseAnswers
              ...
              .success
              .value
              .set(TypeOfTrustPage, HeritageMaintenanceFund)
              .success
              .value
              .set(OwnsUkLandOrPropertyPage, true)
              .success
            ...
            result mustBe JsSuccess(
              MigratingTrustDetails(
                ...
                administrationCountry = country,
                residentialStatus = ResidentialStatusType(nonUK =
                  Some(NonUKType(sch5atcgga92 = false, s218ihta84 = Some(true), agentS218IHTA84 = Some(true)))
                ),
                trustUKProperty = true,
                trustRecorded = true,
                trustUKRelation = Some(true),
