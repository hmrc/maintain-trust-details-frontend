...
class AnswerRowConverter @Inject() (checkAnswersFormatters: CheckAnswersFormatters) {
  ...
  class Bound(userAnswers: UserAnswers)(implicit messages: Messages) {
    ...
    def countryQuestion(query: Gettable[String], labelKey: String, changeUrl: Option[String]): Option[AnswerRow] = {
    ...
    def enumQuestion[T](query: Gettable[T], labelKey: String, changeUrl: Option[String])(implicit
      rds: Reads[T]
    ): Option[AnswerRow] = {
