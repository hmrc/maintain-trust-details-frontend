  ...
  def apply(userAnswers: UserAnswers)(implicit messages: Messages): AnswerSection = {
    ...
    val answerRows: Seq[Option[AnswerRow]] = if (userAnswers.migratingFromNonTaxableToTaxable) {
      Seq(
        ...
        bound
          .yesNoQuestion(GovernedByUkLawPage, "governedByUkLawYesNo", Some(GovernedByUkLawController.onPageLoad().url)),
        bound
          .countryQuestion(GoverningCountryPage, "governingCountry", Some(GoverningCountryController.onPageLoad().url)),
        bound.yesNoQuestion(
          AdministeredInUkPage,
          "administeredInUkYesNo",
          Some(AdministeredInUkController.onPageLoad().url)
        ),
        bound.countryQuestion(
          AdministrationCountryPage,
          "administrationCountry",
          Some(AdministrationCountryController.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          SetUpAfterSettlorDiedPage,
          "setUpAfterSettlorDiedYesNo",
        ...
        bound.enumQuestion(
          ...
          "whyDeedOfVariationCreated",
          Some(WhyDeedOfVariationCreatedController.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          HoldoverReliefClaimedPage,
          "holdoverReliefClaimedYesNo",
        ...
        bound.yesNoQuestion(
          OwnsUkLandOrPropertyPage,
          "ownsUkLandOrPropertyYesNo",
          Some(OwnsUkLandOrPropertyController.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          RecordedOnEeaRegisterPage,
          "recordedOnEeaRegisterYesNo",
          Some(RecordedOnEeaRegisterController.onPageLoad().url)
        ),
        bound.enumQuestion(
          WhereTrusteesBasedPage,
          "whereTrusteesBased",
          Some(WhereTrusteesBasedController.onPageLoad().url)
        ),
        bound
          .yesNoQuestion(SettlorsUkBasedPage, "settlorsUkBasedYesNo", Some(SettlorsUkBasedController.onPageLoad().url)),
        bound.yesNoQuestion(
          CreatedUnderScotsLawPage,
          "createdUnderScotsLawYesNo",
          Some(CreatedUnderScotsLawController.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          PreviouslyResidentOffshorePage,
          "previouslyResidentOffshoreYesNo",
          Some(PreviouslyResidentOffshoreController.onPageLoad().url)
        ),
        bound.countryQuestion(
          PreviouslyResidentOffshoreCountryPage,
          "previouslyResidentOffshoreCountry",
          Some(PreviouslyResidentOffshoreCountryController.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          BusinessRelationshipInUkPage,
          "businessRelationshipInUkYesNo",
          Some(BusinessRelationshipInUkController.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          SettlorBenefitsFromAssetsPage,
          "settlorBenefitsFromAssetsYesNo",
          Some(SettlorBenefitsFromAssetsController.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          ForPurposeOfSection218Page,
          "forPurposeOfSection218YesNo",
          Some(ForPurposeOfSection218Controller.onPageLoad().url)
        ),
        bound.yesNoQuestion(
          AgentCreatedTrustPage,
          "agentCreatedTrustYesNo",
